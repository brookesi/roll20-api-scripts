...
var MapChange = MapChange || (function() {
    ...
    var checkInstall = function() {
        if (!state.MapChange || state.MapChange.version !== version) {
            ...
            state.MapChange = {
                ...
                hiddenMaps: {},
                // Previous page, for toggling back and forth
                previousPage: "",
                // Previous page per player
                previousPages: {}
            };
        }
    ...
    var processCommands = function(msg, commands, params) {
        ...
        switch (commands.shift().toLowerCase()) {
            ...
            case "moveall":
                ...
                break;
            case "revert":
                if(state.MapChange.previousPages[msg.playerid]) {
                    move(msg, msg.playerid, state.MapChange.previousPages[msg.playerid]);
                }
                else {
                    log("Player has no previous page to revert to...");
                }
                break;
            case "revertall":
                moveall(msg, Object.keys(state.MapChange.publicMaps).find(key => state.MapChange.publicMaps[key] === state.MapChange.previousPage));
                break;
            case "block":
    ...
    var showHelp = function(msg, show) {
        ...
        if (show === "index") {
            ...
            text += "<tr><td>menu</td><td>Menu for running commands.</td><td><a style=\"background-color: darkgreen\" href='!mc help --show menu'>Info</a></td></tr>";
            // Add a row for the move command.
            text += "<tr><td>move</td><td>Moves a player to a map.</td><td><a style=\"background-color: darkgreen\" href='!mc help --show move'>Info</a></td></tr>";
            // Check if the calling player is a GM or not.
            if (playerIsGM(msg.playerid)) {
                // If they are then add a row for the moveall command.
                text += "<tr><td>moveall</td><td>Moves all players to a map.</td><td><a style=\"background-color: darkgreen\" href='!mc help --show moveall'>Info</a></td></tr>";
            }
            // Add a row for the rejoin command.
            text += "<tr><td>rejoin</td><td>Rejoins a player to the bookmark.</td><td><a style=\"background-color: darkgreen\" href='!mc help --show rejoin'>Info</a></td></tr>";
            // Check if the calling player is a GM or not.
            if (playerIsGM(msg.playerid)) {
                // If they are then add a row for the rejoinall command.
                text += "<tr><td>rejoinall</td><td>Rejoins all players to the bookmark.</td><td><a style=\"background-color: darkgreen\" href='!mc help --show rejoinall'>Info</a></td></tr>";
                // Add a row for the refresh command.
                text += "<tr><td>refresh</td><td>Refreshes the map lists.</td><td><a style=\"background-color: darkgreen\" href='!mc help --show refresh'>Info</a></td></tr>";
            }
            // Add a row for the help command.
            text += "<tr><td>help</td><td>Shows the help for the script.</td><td><a style=\"background-color: darkgreen\" href='!mc help --show help'>Info</a></td></tr>";
            // Check if the calling player is a GM or not.
            if (playerIsGM(msg.playerid)) {
                // Add a row for the block command.
                text += "<tr><td>block</td><td>Toggle blocking of command use.</td><td><a style=\"background-color: darkgreen\" href='!mc help --show block'>Info</a></td></tr>";
            }
            ...
            // Check if the calling player is a GM or not.
            if (playerIsGM(msg.playerid)) {
                text += "<tr><td>Configuring Maps</td><td><a style=\"background-color: darkgreen\" href='!mc help --show map'>Info</a></td></tr>";
            }
            // Add a row for the information on constructing an API call.
            text += "<tr><td>Constructing an API call</td><td><a style=\"background-color: darkgreen\" href='!mc help --show api'>Info</a></td></tr>";
            // Add a row for the information on using parameters.
            text += "<tr><td>Using Parameters</td><td><a style=\"background-color: darkgreen\" href='!mc help --show params'>Info</a></td></tr>";
            // Add a row for the credits.
            text += "<tr><td>Credits</td><td><a style=\"background-color: darkgreen\" href='!mc help --show credits'>Info</a></td></tr>";
            // Add a row for the version information.
            text += "<tr><td>Version</td><td><a style=\"background-color: darkgreen\" href='!mc help --show version'>Info</a></td></tr>";
            // Add the closing tag for the table.
            text += "</table>";
        }
        ...
        if (show === "menu") {
            ...
            text += "<tr><td colspan='2'>!mc menu</td><td><a style=\"background-color: darkgreen\" href='!mc menu'>Show Me!</a></td></tr>";
            // Add the closing tag for the table.
            text += "</table>";
        ...
        if (show === "move") {
            ...
            text += "<tr><td colspan='3'><strong>Example</strong></td></tr>";
            // Add a row with an example and an api button to launch that example.
            text += "<tr><td colspan='2'>!mc move --target " + _.first(_.keys(state.MapChange.publicMaps)) + "</td><td><a style=\"background-color: darkgreen\" href='!mc move --target " + _.first(_.keys(state.MapChange.publicMaps)) + "'>Show Me!</a></td></tr>";
            // Add the closing tag for the table.
            text += "</table>";
            // Add in a back button for going back to the menu.
        ...
        if (show === "moveall") {
            ...
            text += "<tr><td colspan='3'><strong>Example</strong></td></tr>";
            // Add a row with an example and an api button to launch that example.
            text += "<tr><td colspan='2'>!mc moveall --target " + _.first(_.keys(state.MapChange.publicMaps)) + "</td><td><a style=\"background-color: darkgreen\" href='!mc moveall --target " + _.first(_.keys(state.MapChange.publicMaps)) + "'>Show Me!</a></td></tr>";
            // Add the closing tag for the table.
            text += "</table>";
            // Add in a back button for going back to the menu.
        ...
        if (show === "rejoin") {
            ...
            text += "<tr><td colspan='3'><strong>Example</strong></td></tr>";
            // Add a row with an example and an api button to launch that example.
            text += "<tr><td colspan='2'>!mc rejoin</td><td><a style=\"background-color: darkgreen\" href='!mc rejoin'>Show Me!</a></td></tr>";
            // Add the closing tag for the table.
            text += "</table>";
            // Add in a back button for going back to the menu.
        ...
        if (show === "rejoinall") {
            ...
            text += "<tr><td colspan='3'><strong>Example</strong></td></tr>";
            // Add a row with an example and an api button to launch that example.
            text += "<tr><td colspan='2'>!mc rejoinall</td><td><a style=\"background-color: darkgreen\" href='!mc rejoinall'>Show Me!</a></td></tr>";
            // Add the closing tag for the table.
            text += "</table>";
            // Add in a back button for going back to the menu.
        ...
        if (show === "refresh") {
            ...
            text += "<tr><td colspan='3'><strong>Example</strong></td></tr>";
            // Add a row with an example and an api button to launch that example.
            text += "<tr><td colspan='2'>!mc refresh</td><td><a style=\"background-color: darkgreen\" href='!mc refresh'>Show Me!</a></td></tr>";
            // Add the closing tag for the table.
            text += "</table>";
            // Add in a back button for going back to the menu.
        ...
        if (show === "help") {
            ...
            text += "<tr><td colspan='3'><strong>Example</strong></td></tr>";
            // Add a row with an example and an api button to launch that example.
            text += "<tr><td colspan='2'>!mc help</td><td><a style=\"background-color: darkgreen\" href='!mc help'>Show Me!</a></td></tr>";
            // Add the closing tag for the table.
            text += "</table>";
            // Add in a back button for going back to the menu.
        ...
        if (show === "block") {
            ...
            text += "<tr><td colspan='3'><strong>Example</strong></td></tr>";
            // Add a row with an example and an api button to launch that example.
            text += "<tr><td colspan='2'>!mc block</td><td><a style=\"background-color: darkgreen\" href='!mc help'>Show Me!</a></td></tr>";
            // Add the closing tag for the table.
            text += "</table>";
            // Add in a back button for going back to the menu.
    ...
    var showMenu = function(msg, show) {
        ...
        if (show === "all" || show === "public") {
            ...
            for (var i=0; i<sortedKeys.length; i++) {
                ...
                if (state.MapChange.publicMaps.hasOwnProperty(key)) {
                    ...
                    text += "<td><a style=\"background-color: darkgreen\" href='!mc move --target " + _.escape(key) + "'>" + ((key.length > displayLength) ? key.substr(0, displayLength) + "..." : key) + "</a></td>";
                    // Check if the calling player is a GM or not.
                    if (playerIsGM(msg.playerid)) {
                        // If they are then add extra GM only buttons.
                        // Add a button to teleport all players to the chosen map.
                        text += "<td><a style=\"background-color: darkgreen\" href='!mc moveall --target " + _.escape(key) + "'>All</a></td>";
                        // Add a button to teleport a differnet player to the chosen map.
                        text += "<td><a style=\"background-color: darkgreen\" href='!mc move --target " + _.escape(key) + " --player ?{Player";
        ...
        if (show === "archive") {
            ...
            if (show === "all") {
                ...
                if (playerIsGM(msg.playerid)) {
                    ...
                    text += "<tr><td colspan='3'><a style=\"background-color: darkgreen\" href='!mc menu --show archive'>List All Archive Maps</a></td></tr>";
                }
            }
        }
        ...
        if (show === "hidden") {
            ...
            if (show === "all") {
                ...
                if (playerIsGM(msg.playerid)) {
                    ...
                    text += "<tr><td colspan='3'><strong><em>Hidden</em></strong></td></tr>";
                    // Add a row with a placeholder button for the archived maps.
                    text += "<tr><td colspan='3'><a style=\"background-color: darkgreen\" href='!mc menu --show hidden'>List All Hidden Maps</a></td></tr>";
                }
            }
        }
        ...
        if (show === "all" || show === "utilities" || show === "utils" || show === "archive" || show === "hidden") {
            ...
            text += "<td><a style=\"background-color: darkgreen\" href='!mc rejoin'>Rejoin</a></td>";
            // Check if the caller is a GM or not.
            if (playerIsGM(msg.playerid)) {
                // Add an api button for the GM to force all players to rejoin the bookmark.
                text += "<td><a style=\"background-color: darkgreen\" href='!mc rejoinall'>All</a></td>"
                // Add an api button for the GM to force rejoin another player to the bookmark.
                text += "<td><a style=\"background-color: darkgreen\" href='!mc rejoin --player ?{Player";
                // Loop through the players in the campaign adding them to the dropdown for the command.
                for (var key in players) {
                    if (players.hasOwnProperty(key)) {
                        // Add the current players name with any brackets replaced for their ASCII equivalents.
                ...
                text += "<td><a style=\"background-color: darkgreen\" href='!mc refresh'>Refresh</a></td>";
            }
            // Check if the caller is a GM or not.
            if (!playerIsGM(msg.playerid)) {
                // Add an api button for the help command.
                text += "<td><a style=\"background-color: darkgreen\" href='!mc help'>Help</a></td>";
            }
            ...
            if (playerIsGM(msg.playerid)) {
                ...
                text += "<td colspan='2'><a style=\"background-color: darkgreen\" href='!mc block --player ?{Player";
                // Loop through the players in the campaign adding them to the dropdown for the command.
                for (var key in players) {
                    if (players.hasOwnProperty(key)) {
                        // Add the current players name with any brackets replaced for their ASCII equivalents.
                ...
                // Add an api button for the help command.
                text += "<td><a style=\"background-color: darkgreen\" href='!mc revertall'>Revert</a></td>";
                text += "<td><a style=\"background-color: darkgreen\" href='!mc help'>Help</a></td></tr>";
            }
    ...
    var getPageNameFromId = (id) => {

        const pageObj = getObj("page", id);
        return pageObj.get("name");
    }

    // Moves a player to the specified map.
    var move = function(msg, sender, target) {
        var pages = findObjs({_type: 'page'});
        var playerObj = getObj("player", sender);
        ...
        if (target in state.MapChange.publicMaps) {
            // Move player.
            state.MapChange.previousPages[sender] = getPageNameFromId(Campaign().get('playerpageid'));
    ...
    // Add the archive maps move in here
    var moveall = function(msg, target) {
        if (playerIsGM(msg.playerid)) {
            var bookmarkPage = Campaign().get("playerpageid");
            state.MapChange.previousPage = bookmarkPage;
            if (target in state.MapChange.publicMaps) {
                Campaign().set("playerspecificpages", false);
    ...
    var navigation = function(prev, next) {
        ...
        if (prev !== "") {
            ...
            text += "<td><a style=\"background-color: darkgreen\" href='!mc help --show " + prev + "'>Previous</a></td>";
        }
        // Add in the row for the back button.
        text += "<td><a style=\"background-color: darkgreen\" href='!mc help'>Back</a></td>";
        // Check if next is not empty.
        if (next !== "") {
            // If it is then add a table element in for the next button.
            text += "<td><a style=\"background-color: darkgreen\" href='!mc help --show " + next + "'>Next</a></td>";
        }
        // Add the closing tag for the table.
        text += "</tr></table>";
...
on("ready", function() {
    ...
    log("- Blocked Players: " + state.MapChange.blockedPlayers);
